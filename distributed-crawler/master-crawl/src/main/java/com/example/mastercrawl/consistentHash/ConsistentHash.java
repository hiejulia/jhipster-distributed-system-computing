...
public class ConsistentHash<T> {
     ...
     */
    private final HashFunc hashFunction;
    /**
     * virtual node Number of Replicas
     */
    private final int numberOfReplicas;
    /**
     * Store object corresponding to its Hashcode key calculated in Md5
     */
    private final SortedMap<Integer, T> circle = new TreeMap<Integer, T>();


    public ConsistentHash(HashFunc hashFunction, int numberOfReplicas){
